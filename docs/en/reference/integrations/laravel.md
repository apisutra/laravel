...
Requires Laravel 13.12+, PHP 8.4+ and `apisutra/php:^0.1`. Install `apisutra/laravel`; it supplies package discovery. No mandatory configuration file or publication is required.
